...
public interface StockRepository extends JpaRepository<Stock,Integer> {
    ...
    @Query(value ="select distinct i.barCode,i.itemName,i.itemQtyOnHand,b.brandName,a.supplierName,a.company from Item i ,Brand b,StockItemDetails sd, Stock s ,Supplier a  where  sd.stock.stockId=s.stockId and i.brand.brandId=b.brandId  and i.itemQtyOnHand < i.stockLevel and s.supplier.supplierId=a.supplierId")
